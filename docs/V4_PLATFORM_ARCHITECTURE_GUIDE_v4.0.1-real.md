# V4 Platform Architecture Guide — v4.0.1-real

## What v4.0 Stabilizes

v4.0.1-real stabilizes the operator intelligence platform after the v3 feature expansion. It adds shared version metadata, safety helpers, export helpers, route inventory, plugin manifest validation, platform diagnostics, and storage compatibility notes.
