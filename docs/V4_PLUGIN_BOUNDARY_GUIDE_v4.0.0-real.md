# V4 Plugin Boundary Guide — v4.0.0-real

## Summary

v4.0.0-real introduces plugin manifests as a metadata-only extension boundary. This is not executable plugin support.
...
v4.0.0-real validates and displays manifests only. It does not provide executable plugins or dynamic route loading.
